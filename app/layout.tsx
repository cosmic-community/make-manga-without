...
export const metadata: Metadata = {
  title: 'Make Manga Without — A Krishna-Inspired Tale',
  description: 'A manga about 5 kids on adventures without weapons or magical powers, inspired by the timeless tales of Lord Krishna.',
}
